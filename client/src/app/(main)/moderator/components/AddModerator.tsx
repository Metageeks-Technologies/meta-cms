        ...
        <div>
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogTrigger asChild>
                    <Button variant="default" className='bg-green-500 text-white font-bold text-base hover:bg-green-600'>Add Moderator +</Button>
                </DialogTrigger>

                <DialogContent className="sm:max-w-[450px] bg-black border-gray-800 text-white">
                    <DialogHeader>
                        <DialogTitle className='text-2xl'>Add Moderator</DialogTitle>
                    </DialogHeader>
                    <form onSubmit={handleCreateModerator} className="py-4">
                        <div className="mb-4">
